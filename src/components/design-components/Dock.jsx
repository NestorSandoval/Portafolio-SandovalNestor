  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} fixed bg-red-800 bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-black border-2 pb-2 px-4`}
